...
public class SendMessageServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			content = req.getParameter(Datastore.PARAMETER_JSON);
			regId = req.getParameter(PARAMETER_DEVICE);
			multicastKey = req.getParameter(PARAMETER_MULTICAST);
		} catch (Exception e) {
			e.printStackTrace();
			return;
		}
		...
		message = new Message.Builder()
			.delayWhileIdle(true)
			.addData(Datastore.PARAMETER_JSON, content)
			.build();
